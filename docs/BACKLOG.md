<!-- Modified by the buzz-zcode-harness fork in 2026 for Buzz compatibility tracking. -->
...
| `interaction/requestOfficialMcpAuthHeaders` (0.16.5)                                                                                                        | Server→client request: official MCP auth headers                       | Replied immediately with schema-valid `official_auth_unavailable`; external ACP cannot access ZCode Desktop's proprietary signed-in credential service                                                                              |
| `session/requestRuntimePreferences` (0.16.5)                                                                                                                | Runtime preference negotiation                                         | Replied immediately with conservative defaults; AskUserQuestion auto-resolution remains disabled                                                                                                                                    |
